            ...
            <div class="on-hover-card">
                ...
                <div class="more-info-wrapper">
                    <div class="link-wrapper">
                        ...
                        <svg class="link" viewBox="0 -0.5 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M14 7H16C18.7614 7 21 9.23858 21 12C21 14.7614 18.7614 17 16 17H14M10 7H8C5.23858 7 3 9.23858 3 12C3 14.7614 5.23858 17 8 17H10M8 12H16" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>  
                        <a href="${item.demo}" target="_blank" class="more-info">Demo</a>
                    </div>
                    <div class="link-wrapper">
                        ...
                        <a href="${item.github} "target="_blank" class="more-info">GitHub</a>
                    </div>   
                </div>
            </div>
        </div>
